...
export function DisplayPreferencesForm({
  ...
  setPrefs: React.Dispatch<React.SetStateAction<DisplayPreferences>>;
}) {
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <p className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">Accent</p>
      ...
      <div className="space-y-2">
        <p className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">Density</p>
        <div className="grid grid-cols-2 gap-2">
